<template>
	<div>
		<el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
			...
			<el-form-item prop="pid" v-if="ruleForm.roleid == 2 || ruleForm.roleid == 1 ? false : true" label="上级代理">
			...
			<el-form-item label="权限">
				<el-radio @change="RadioChange" v-model="ruleForm.roleid" v-if="this.User.roleid == 1" label="1">管理员</el-radio>
				<el-radio @change="RadioChange" v-model="ruleForm.roleid" v-if="this.User.roleid == 1" label="2">代理商</el-radio>
